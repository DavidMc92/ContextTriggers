...
// Hacky; placing an intent in the XML leads to an exception when user instead clicks on option
public class LocationEditTextPreference_Home extends EditTextPreference {
    static final private int DEFAULT_MINIMUM_LOCATION_LENGTH = 2;
    private int mMinLength;

    public LocationEditTextPreference_Home(Context context, AttributeSet attrs) {
        super(context, attrs);
            ...
            public void onClick(View v) {
                ...
                try {
                    activity.startActivityForResult(builder.build(activity),
                            MainActivity.UserPreferenceActivity.PLACE_PICKER_REQUEST_HOME);
